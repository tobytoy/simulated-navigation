...
export const INITIAL_EVENTS: TrafficEvent[] = [
  ...
  },
  {
    ...
    type: 'poi',
    title: '7-Eleven 航醫門市',
    description: '靠近交通部，提供現磨咖啡、熱食便當及各類急需生活補給。',
    lat: 25.0386,
    lng: 121.5225,
    roadName: '杭州南路一段 / 仁愛路口',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    id: 'evt_poi_2',
    type: 'poi',
    title: '全家便利商店 華山門市',
    description: '華山 1914 創意文化園區旁，設有豐富休息座位區，深受旅客喜愛。',
    lat: 25.0438,
    lng: 121.5255,
    roadName: '忠孝東路一段 85 號',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    id: 'evt_poi_3',
    type: 'poi',
    title: '7-Eleven 鑫新生門市',
    description: '新生高架橋旁，設有中國信託 ATM 及精品咖啡現烤麵包專櫃。',
    lat: 25.0432,
    lng: 121.5312,
    roadName: '新生南路一段 / 忠孝東路口',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    ...
    type: 'poi',
    title: '星巴克 捷運台大醫院門市',
    description: '提供高品質現煮咖啡與精緻糕點，為繁忙的通勤族與醫護人員注入活力。',
    lat: 25.0420,
    lng: 121.5182,
    roadName: '中山南路 / 捷運台大醫院站 4 號出口',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    ...
    type: 'poi',
    title: '麥當勞 台北新生店',
    description: '提供經典漢堡、薯條與快速餐點，設有舒適的用餐區。',
    lat: 25.0455,
    lng: 121.5210,
    roadName: '忠孝東路一段 120 號',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    id: 'evt_poi_6',
    type: 'poi',
    title: '台大醫院 (NTU Hospital)',
    description: '國家級醫學中心大型教學醫院，設有全天候急診與頂尖醫療團隊。',
    lat: 25.0415,
    lng: 121.5198,
    roadName: '中山南路 7 號',
    severity: 'low',
  ...
  },
  {
    ...
    type: 'poi',
    title: '捷運 台大醫院站',
    description: '台北捷運淡水信義線（紅線）重要站點，出入口鄰近二二八和平紀念公園。',
    lat: 25.0427,
    lng: 121.5186,
    roadName: '公園路 / 常德街口',
    severity: 'low',
  ...
  },
  {
    id: 'evt_poi_8',
    type: 'poi',
    title: 'Tesla 超級充電站 - 建國高架站',
    description: '設有 V3 超級充電樁，最大支援 250kW 高速電能補充，適合車輛快速補電。',
    lat: 25.0360,
    lng: 121.5385,
    roadName: '建國南路一段 (高架橋下停車場)',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    id: 'evt_poi_9',
    type: 'poi',
    title: 'YouBike 2.0 交通部',
    description: '站點狀態：正常營運。可借車輛：12 輛，可還車位：8 格。',
    lat: 25.0381,
    lng: 121.5240,
    roadName: '仁愛路一段 (交通部大樓前)',
    severity: 'low',
    createdAt: '2026-07-09 11:23',
  },
  {
    ...
    type: 'poi',
    title: '公車站 - 華山文創園區',
    description: '行經路線：205, 257, 262, 276, 299, 忠孝幹線。即將到站：299 (2分鐘), 忠孝幹線 (5分鐘)。',
    lat: 25.0443,
    lng: 121.5265,
    roadName: '忠孝東路一段 85 號',
    severity: 'low',
